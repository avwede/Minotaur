...
## Advtanges and Disdvanages for MinotaursCrystalVase
I chose the second option because it allows the guest to go about the party if the door is busy
Some of the disadvantages would be that a guest could enter twice before allowing other guests to enter this would also create very long wait times for the guests.
